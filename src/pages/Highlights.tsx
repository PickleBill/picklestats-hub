...
import { clips, Clip } from "@/data/clips";
  ...
  return (
    ...
    >
      <div className="relative aspect-video">
        ...
        <Badge className={`absolute top-2 left-2 ${clip.arcColor} border-0 text-foreground`}>
          {clip.arc}
        </Badge>
      </div>
      <CardContent className="pt-4 space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Viral: <span className="text-gold font-semibold">{clip.viral}/10</span>
        </p>
      </CardContent>
    </Card>
  );
